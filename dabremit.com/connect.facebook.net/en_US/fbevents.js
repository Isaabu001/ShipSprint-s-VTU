            ...
            return function(g, h, j, k) {
                ...
                (function() {
                    ...
                    function B(b) {
                        ...
                        c = c != null ? a({}, c) : null;
                        var p = j.href;
                        Object.prototype.hasOwnProperty.call(b, "documentLink") ? p = n : b.documentLink = p;
                        n = h.referrer;
                ...
                (function() {
                    ...
                    k = new b(function(a, b) {
                        ...
                        c.listen(function(c) {
                            ...
                            d = p(c != null && (d.isOptedIn(c.id, "AutomaticSetup") || d.isOptedIn(c.id, "InferredEvents") || d.isOptedIn(c.id, "Microdata")), i.AUTO_CONFIG);
        ...
        f.ensureModuleRegistered("SignalsFBEvents", function() {
            return function(a, b, c, d) {
                ...
                (function() {
                    ...
                    function Aa(a) {
                        a.instance = W, a.callMethod = Y, a._initHandlers = [], a._initsDone = {}, a.send = sa, a.getEventCustomParameters = ta, a.addInitHandler = ya, a.getState = za, a.init = Z, a.set = ma, a.loadPlugin = function(a) {
